    ...
    <div className="contact_sec">
      <div className="contact_box">
        ...
        <div style={{ maxWidth: "450px" }} className="formdiv">
          <form
            action="https://formsubmit.co/adepusaipranay12345@gmail.com"
            method="post"
            style={{ width: "100%" }}
          >
